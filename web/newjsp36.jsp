<%-- 
    Document   : newjsp36
    Created on : Oct 5, 2017, 8:56:04 PM
    Author     : Anmol Natt
--%>
...
<table id="table2" onmouseenter="qwe();" onmouseover="qwe();" onmouseout="qwer();">
    ...
    <tr><td>and cancellation of booking can be made possible.
        ...
        <img  src="D:\New Folder\8.jpg" style="" id="img5"></img>
        <img  src="D:\New Folder\9.jpg" style="" id="img6"></img>
        <img  src="D:\New Folder\10.jpg" style="" id="img7"></img>
        <img  src="D:\New Folder\11.jpg" style="" id="img8"></img>
        <img  src="D:\New Folder\12.jpg" style="" id="img9"> </img>
