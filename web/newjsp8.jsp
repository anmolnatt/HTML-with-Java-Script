<%-- 
    Document   : newjsp8
    Created on : Sep 22, 2017, 9:40:45 PM
    Author     : Anmol Natt
--%>
        ...
        <script>
            function abc()
            {
              ...
              b= document.getElementById("text6").value;
                ...
                if (a==("")&&b==(""))
                    {
                        alert("Please Enter the Dealer Id and Passsword");
                    }
                    else if (a==(""))
                    {
                        alert("Please Enter the Dealer Id");
                    }
                else if (b==(""))
                    {
...
<table id="table2" onmouseenter="qwe();" onmouseover="qwe();" onmouseout="qwer();">
    ...
    <tr><td>and cancellation of booking can be made possible.
        ...
        <form action="newjsp15.jsp">
            <p id="p4">Dealer ID:</p> <input type="text" name="text1" id="text5"/> 
    ...
    <table id="table1" style="color: #bfbfbf;font-family:Microsoft Sans Serif;font-weight: 500; letter-spacing: .5px;width:90%">
        ...
        try
        {
        if(session.getAttribute("DealerLogin").equals("loggedin"))
                       {
