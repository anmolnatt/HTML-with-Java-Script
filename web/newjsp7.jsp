<%-- 
    Document   : newjsp7
    Created on : Sep 22, 2017, 9:40:32 PM
    Author     : Anmol Natt
--%>
...
<table id="table2" onmouseenter="qwe();" onmouseover="qwe();" onmouseout="qwer();">
    ...
    <tr><td>and cancellation of booking can be made possible.
        ...
        <table id="table3">
            <tr><td id="t1">City</td><td id="t1">Subsidised</td><td id="t1">Non-Subsidised</td><td id="t1">Commercial</td></tr>
        <%
        ...
        try
        {
            Class.forName("sun.jdbc.odbc.JdbcOdbcDriver") ;
              ...
              ResultSet rs1=st1.executeQuery("select * from rates");
              while(rs1.next())
              {
                 %><tr><td id="t1"><%out.print(rs1.getString(1));%></td><%
                 %><td id="t1">₹<%out.print(rs1.getString(2));%></td><%
                 %><td id="t1">₹<%out.print(rs1.getString(3));%></td><%
                 %><td id="t1">₹<%out.print(rs1.getString(4));%></td></tr><%
              } 
