<%-- 
    Document   : newjsp5
    Created on : Sep 22, 2017, 9:40:11 PM
    Author     : Anmol Natt
--%>
        ...
        <script>
            function abc()
            {
              ...
              h= document.getElementById("text12").value;
                ...
                if (a!=("")&&b!=("")&&c!=("")&&d!=("")&&e!=("")&&f!=("")&&g!=("")&&h!=(""))
                   {
                       alert("Your request is register. We will contact you as soon as possible");
                   }
                else if (a==(""))
                    {
...
<table id="table2" onmouseenter="qwe();" onmouseover="qwe();" onmouseout="qwer();">
    ...
    <tr><td>and cancellation of booking can be made possible.
        ...
        <form action="newjsp18.jsp">
            <p id="p4">Name: </p><input type="text" name="text1" id="text5"/> 
            <p id="p4">Father Name: </p><input type="text" name="text2" id="text6"/> 
            <p id="p4">Contact: </p><input type="text" name="text3" id="text7"/> 
            <p id="p4">Email: </p><input type="text" name="text4" id="text8"/> 
            <p id="p4">Gender: </p><input type="text" name="text5" id="text9"/> 
            <p id="p4">Address: </p><input type="text" name="text6" id="text10"/> 
            <p id="p4">AAdhar Card Number: </p><input type="text" name="text7" id="text11"/> 
            <p id="p4">PAN Card Number: </p><input type="text" name="text8" id="text12"/> 
            
            <input type="submit" value="Apply" id="submit3" onclick="abc();"/>
        </form>
